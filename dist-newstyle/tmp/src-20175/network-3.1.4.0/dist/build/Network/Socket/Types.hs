...
invalidSocket = 18446744073709551615
...
{-# LINE 374 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 823 "Network\\Socket\\Types.hsc" #-}
...
pattern AF_IRDA             = Family (26)
{-# LINE 918 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 927 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 1084 "Network\\Socket\\Types.hsc" #-}
type CSaFamily = (Word16)
{-# LINE 1085 "Network\\Socket\\Types.hsc" #-}

{-# LINE 1090 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 1113 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 1148 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 1152 "Network\\Socket\\Types.hsc" #-}
pokeSockAddr p (SockAddrInet port addr) = do
    zeroMemory p (16)
{-# LINE 1154 "Network\\Socket\\Types.hsc" #-}
...
pokeSockAddr p (SockAddrInet6 port flow addr scope) = do
    zeroMemory p (28)
{-# LINE 1162 "Network\\Socket\\Types.hsc" #-}

{-# LINE 1165 "Network\\Socket\\Types.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 0)) p ((23) :: CSaFamily)
{-# LINE 1166 "Network\\Socket\\Types.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 2)) p port
{-# LINE 1167 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 1175 "Network\\Socket\\Types.hsc" #-}
...
s6_addr_offset :: Int
s6_addr_offset = ((0))
{-# LINE 1252 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 1280 "Network\\Socket\\Types.hsc" #-}

instance Storable In6Addr where
    sizeOf    _ = 16
{-# LINE 1283 "Network\\Socket\\Types.hsc" #-}
    alignment _ = 2
{-# LINE 1284 "Network\\Socket\\Types.hsc" #-}
